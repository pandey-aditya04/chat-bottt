...
const AIMessageBar = () => {
  ...
  return (
    <div className="w-full max-w-xl mx-auto h-[600px] bg-gradient-to-br from-slate-900 to-indigo-950 rounded-xl overflow-hidden shadow-2xl border border-indigo-500/20 flex flex-col">
      {/* Header */}
